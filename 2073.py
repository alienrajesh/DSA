...
# the 0th person is at the front of the line and the (n - 1)th person
# is at the back of the line.
# You are given a 0-indexed integer array tickets of length n
# where the number of tickets that the ith person would like to buy is
# tickets[i].
...
# Output: 6
# Explanation: 
# - In the first pass, everyone in the line buys a ticket and the
# line becomes [1, 2, 1].
...
# Output: 8
# Explanation:
# - In the first pass, everyone in the line buys a ticket and th

# line becomes [4, 0, 0, 0].
