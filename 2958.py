...
#             values 1, 2, and 3 occur at most twice in this subarray. Note that
#             the subarrays [2,3,1,2,3,1] and [3,1,2,3,1,2] are also good.
#             It can be shown that there are no good subarrays with length more
#             than 6.
#
# Example 2:
